...
import Login from "src/components/Dashboard/Views/Registration/Registration.vue";
  ...
  lockPage,
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "courses",
        component: () =>
          import("@/components/Dashboard/Views/Courses/Home.vue"),
        children: [
          {
            path: "",
            name: "MainCourses",
            component: () =>
              import("@/components/Dashboard/Views/Courses/CoursesPage.vue"),
          },
          {
            path: ":id",
            name: "CoursePreview",
            component: () =>
              import("@/components/Dashboard/Views/Courses/CoursePreview.vue"),
          },
        ],
      },
      {
        ...
        name: "learner",
        component: () =>
          import("@/components/Dashboard/Views/Learner/Learner.vue"),
      },
      {
        path: "registrations",
        name: "registrations",
        component: () =>
          import("@/components/Dashboard/Views/Registration/Registration.vue"),
      },
    ],
  },
